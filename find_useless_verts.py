...
def find_useless_verts(bm, min_angle):
    print("Running find_useless_verts()")
...
def main(self, context):
    ...
    for object in context.selected_objects:
        ...
        numUselessVerts += find_useless_verts(bm,min_angle)
        bmesh.update_edit_mesh(mesh)
        bm.free()
    
    self.report({'INFO'},"Found "+ str(numUselessVerts) +" Useless Verts")
    return
####################################################################################################################


class MESH_OT_find_useless_verts(bpy.types.Operator):
    bl_idname = "mesh.find_useless_verts"
    bl_label = "Find Useless Verts"
...
# class PANEL_find_useless_verts(bpy.types.Panel):
#     bl_idname = "panel_find_useless_verts"
#     bl_label = "Find Useless Verts"
...
def register():
#    bpy.utils.register_class(PANEL_find_useless_verts)
    bpy.utils.register_class(MESH_OT_find_useless_verts)

def unregister():
    bpy.utils.unregister_class(MESH_OT_find_useless_verts)
#    bpy.utils.unregister_class(PANEL_find_useless_verts)
